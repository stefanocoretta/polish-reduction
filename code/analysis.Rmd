...
options(ggplot2.discrete.fill = list(c("#264653", "#e76f51"), c("#B09B37", "#955F47", "#A8B9CB")))
```
...
```{r save-rate-stress}
ggsave(dur.stress.rate, file = "./figures/dur_descriptive.pdf", width = 6, height = 3, device = cairo_pdf)
```
